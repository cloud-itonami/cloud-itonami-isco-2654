(ns video-production.advisor
  "VideoOpsAdvisor — proposes a video-production operation (timeline
  ...
  consent/rights clearance; `video-production.governor` is the independent
...
(def ^:private system-prompt
  "You are a video-production advisor for an independent director/producer.
   Given an operation request (timeline assembly, publication), propose an
